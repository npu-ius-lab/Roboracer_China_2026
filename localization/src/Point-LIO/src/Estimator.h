...
struct MapBackendStats
{
    uint64_t knn_queries = 0;
    uint64_t knn_success = 0;
    double knn_total_ms = 0.0;
    double knn_max_ms = 0.0;
...
extern std::shared_ptr<LocalMapBackend> local_map_backend_;
extern MapBackendStats map_backend_stats;
