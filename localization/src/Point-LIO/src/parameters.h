...
extern std::string local_map_backend_name;
extern float octvox_resolution;
extern int octvox_capacity;
extern state_input state_in;
extern state_output state_out;
extern std::string lid_topic, imu_topic, publish_world_frame;
...
extern double odometry_max_publish_hz;
extern std::string odometry_tf_child_frame;
extern double odometry_tf_child_to_body_x_m;
extern double odometry_tf_child_to_body_y_m;
extern double odometry_tf_child_to_body_z_m;
...
extern bool   scan_world_publish_en, scan_world_downsample_publish_en;
extern bool   scan_bodyframe_pub_en;
extern bool   recovery_cloud_enable;
extern double recovery_cloud_max_hz;
extern bool   enable_lidar_backlog_catchup;
extern bool   enable_map_backend_timing;
extern double lidar_backlog_trigger_s, lidar_backlog_target_s;
extern size_t min_lidar_frames_to_keep;
extern int    sensor_callback_threads;
extern int    lidar_sub_queue_size, imu_sub_queue_size;
extern int    odom_pub_queue_size, cloud_pub_queue_size, path_pub_queue_size;
