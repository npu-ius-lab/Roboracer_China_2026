#ifndef POINT_LIO_SAM_LIGHTERBEV_POSE_PCD_HPP
#define POINT_LIO_SAM_LIGHTERBEV_POSE_PCD_HPP
                        ...
                        const int &idx_in)
{
    ...
    pcd_ = transformPcd(tmp_pcd, pose_eig_.inverse()); // Point-LIO publishes /cloud_registered in world frame,
                                                       // so keep each keyframe cloud in its local LiDAR frame.
