...
ENTRY="$CONTROLLER_WS/scripts/start_mpcc_hardware_stable_roboracer_oldmap_c11_outer_boundary_expanded_h2h_green_c10_c12_no_stop_candidate.sh"

[[ -x "$ENTRY" ]] || { echo "[FAIL] missing launcher: $ENTRY" >&2; exit 1; }
export H2H_SPEED_CAP_MPS=4.0
