...
class LivoxPointsPlugin : public RayPlugin {
 ...
 private:
    ...
    ros::Publisher livoxPointPub;
    ros::Publisher bodyCloudPub;

    std::string frameId = "livox_frame";
    std::string bodyFrameId = "body";
    double bodyOffsetX = 0.03;
    double bodyOffsetY = 0.0;
    double bodyOffsetZ = 0.19;
