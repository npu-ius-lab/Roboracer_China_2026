...
// Stable V5 remains linked to AcadosRuntimeSolver. Only the new Jubu
// executable uses this independent solver wrapper.
class AcadosRuntimeSolverJubu {
 public:
  AcadosRuntimeSolverJubu(
  ...
  ~AcadosRuntimeSolverJubu();
  AcadosRuntimeSolverJubu(const AcadosRuntimeSolverJubu&) = delete;
  AcadosRuntimeSolverJubu& operator=(const AcadosRuntimeSolverJubu&) = delete;
