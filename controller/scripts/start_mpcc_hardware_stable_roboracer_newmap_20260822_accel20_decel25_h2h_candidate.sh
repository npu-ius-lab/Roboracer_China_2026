...
# H2H companion for the additive +2.0/-2.5 m/s^2 new-map candidate.
ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
export TWO_MAP_TRACK="raceline_newmap_20260822_c11_c12_smooth_candidate"
export TWO_MAP_H2H_CANDIDATE_NAME="stable_roboracer_newmap_20260822_accel20_decel25_h2h_guarded"
