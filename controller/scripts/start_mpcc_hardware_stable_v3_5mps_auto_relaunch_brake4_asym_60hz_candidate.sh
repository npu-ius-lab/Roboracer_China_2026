...
BASE_LAUNCHER="$ROOT/scripts/start_mpcc_hardware_stable_v3_5mps_auto_relaunch_brake4_asym_candidate.sh"
BASE_CONTROLLER="$ROOT/src/f1tenth_dynamic_mpcc/config/candidates/stable_v3_5mps_auto_relaunch_brake4_asym_candidate/controller.yaml"
BASE_LAUNCH="$ROOT/src/f1tenth_dynamic_mpcc/launch/hardware_mpcc_stable_v3_5mps_auto_relaunch_brake4_asym_candidate.launch"
CANDIDATE="stable_v3_5mps_auto_relaunch_brake4_asym_60hz_candidate"
...
LAUNCH="$ROOT/src/f1tenth_dynamic_mpcc/launch/hardware_mpcc_stable_v3_5mps_auto_relaunch_brake4_asym_60hz_candidate.launch"
...
# Prove the exact brake4/asymmetric 40 Hz inputs used as this candidate's
# baseline remain unchanged without invoking unrelated launcher dependencies.
check_hash "2872cb3f86958813a3ac4a7d779d3319c20c1f6b3b107a578a0544ed77a56ee1" "$BASE_LAUNCHER"
...
check_hash "5b03916a4d8e53e2d15a692ff5f909a1df3f4ac5f2d9af1f66f828df87ac3fff" "$CONTROLLER"
check_hash "f099815be9262454a8d62598ec95fd5ef7a1c0092a0f6fea77619d60d72d374c" "$LAUNCH"
...
check_hash "af8809384f599db817ed360adc06a0e5bcf9cf6c1f453e6a585387f92d5ca151" "$RECORDER"
...
if [[ "${MPCC_RECORD_BAG:-false}" == "true" ]]; then
  mkdir -p "$ROOT/bags"
  BAG_PATH="${MPCC_RECORD_BAG_PATH:-$ROOT/bags/stable_v3_5mps_auto_relaunch_brake4_asym_60hz_${STAMP}.bag}"
  "$RECORDER" "$BAG_PATH" &
  RECORD_PID=$!
...
LAUNCH_ARGS=(
  ...
  telemetry_path:="$ROOT/log/hardware_stable_v3_5mps_auto_relaunch_brake4_asym_60hz_${STAMP}.jsonl"
  lap_timer:="${AUTO_RELAUNCH_LAP_TIMER:-true}"
  lap_log_path:="$ROOT/log/laps_stable_v3_5mps_auto_relaunch_brake4_asym_60hz_${STAMP}.csv"
)

if [[ -n "$RECORD_PID" ]]; then
  roslaunch f1tenth_dynamic_mpcc \
    hardware_mpcc_stable_v3_5mps_auto_relaunch_brake4_asym_60hz_candidate.launch \
    "${LAUNCH_ARGS[@]}"
else
