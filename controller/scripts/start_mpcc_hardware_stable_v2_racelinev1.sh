...
VEHICLE="$ROOT/src/f1tenth_dynamic_mpcc/config/vehicle_stable_v2.yaml"
TRACK="${MPCC_TRACK:-racelinev1}"
RACELINE="$ROOT/src/f1tenth_dynamic_mpcc/data/tracks/$TRACK/raceline.csv"
VEHICLE_CONFIG="vehicle_stable_v2.yaml"
...
# Frozen snapshot of the verified 2026-08-17 candidate run:
# unified steering model + 3.4 rad/s + OOB PP recovery + tire Cf=70/Cr=110,
# The controller/residual/vehicle hashes stay pinned to that verified profile.
# The newly deployed competition raceline is pinned separately; its runtime
# speed cap defaults to the stable V2 value of 3.0 m/s.
...
check_hash "bc3c6662a862a1de7f1d8de095df3f621d4af2aa39138cd0300825aa1d5eed1d" "$VEHICLE"
...
GENERATED_DIR="${MPCC_GENERATED_DIR:-$HOME/.cache/f1tenth_residual_mpcc/acados_stable_v2}"
