...
# Additive 4.5 m/s React/local-reference MPCC variant of:
...
REACT_CONFIG="$PACKAGE_DIR/config/react_c11_4p5_candidate.yaml"
REACT_CONFIG_SHA256="99e37ae9cb288cdf793aa7d3a43cfeef5399a41b7f5449412b324da7685e1af4"
...
TRACK_CSV="$ROOT/src/f1tenth_dynamic_mpcc/data/tracks/raceline_smooth_c11_outer_boundary_expanded_arc_straight_4p5_candidate/raceline.csv"
TRACK_SHA256="f42badd7a7d22b7371d8b6b0afcb6d96c192e6fc2e12c6a23af4c8d0fbffe906"
...
CONTROLLER_SHA256="14df4868242fdd905ad2e75f34954c915f57c06134c96ddcddcf08794dba2e77"
...
echo "[OK] old-map C11-expanded 4.5 track shared by React, MPCC, supervisor, and lap timer"
echo "[OK] controller=C11 4.5 candidate; accel/decel=1.5/2.0 m/s^2; cap<=4.5 m/s"
echo "[OK] React GLOBAL cruise=4.5 m/s; PASS/RETURN/FOLLOW remain 3.2/3.0/1.0-2.4 m/s"
...
GENERATED_DIR="${MPCC_GENERATED_DIR:-$HOME/.cache/f1tenth_residual_mpcc/acados_stable_roboracer_oldmap_c11_react_4p5}"
...
export MPCC_TRACK="raceline_smooth_c11_outer_boundary_expanded_arc_straight_4p5_candidate"
...
if ! awk -v value="$RESIDUAL_MPCC_SPEED_CAP" \
  ...
  echo "[FAIL] C11 React 4.5 RESIDUAL_MPCC_SPEED_CAP must be in (0, 4.5]" >&2
  exit 2
fi
...
case "${MPCC_RECORD_BAG:-false}" in
  true|TRUE|yes|YES|1)
    BAG_PATH="${MPCC_RECORD_BAG_PATH:-$ROOT/bags/roboracer_oldmap_c11_react_4p5_${STAMP}.bag}"
    "$RECORDER" "$BAG_PATH" &
    pids+=("$!")
...
echo "[ROBORACER_C11_REACT_4P5] baseline=oldmap C11 outer-boundary-expanded 4.5 candidate"
echo "[ROBORACER_C11_REACT_4P5] global controller=C11 4.5 residual MPCC"
...
roslaunch roboracer_react_fast_overtake roboracer_c11_react_control.launch \
  ...
  telemetry_path:="$ROOT/log/hardware_roboracer_oldmap_c11_react_4p5_${STAMP}.jsonl" \
  lap_timer:="${AUTO_RELAUNCH_LAP_TIMER:-true}" \
  lap_log_path:="$ROOT/log/laps_roboracer_oldmap_c11_react_4p5_${STAMP}.csv" \
